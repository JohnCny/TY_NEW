 ...
 */
@Mapper
public interface CustomerInforRecordDao {
	
	public List<CustomerRecord> findCustomerRecordList(CustomerRecordFilter filter);
	public int findCustomerRecordListCount(CustomerRecordFilter filter);
	
	public List<CustomerRecord> findCustomerRecordEnterList(CustomerRecordFilter filter);
	public int findCustomerRecordEnterListCount(CustomerRecordFilter filter);
